...
public class EnquiryDetailsController {
	...
	public ResponseEntity<BaseResponce<List<EnquiryDetails>>> getData(){
		 
		BaseResponce<List<EnquiryDetails>> response= new BaseResponce<List<EnquiryDetails>>(200,new Date(),"Data Fetched Successfully",enquiryDetailsInterface.getAllData());
		
		return new ResponseEntity<BaseResponce<List<EnquiryDetails>>>(response, HttpStatus.OK);
	}
